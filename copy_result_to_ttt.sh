...
RESULT_FILE2_LP=image-rk3566-leopad-10s.dtb # DTB
...
cat ${RESULT_DIR}/${RESULT_FILE2_LP} | pv -s ${RESULT_SIZE} > ${DEST_DIR}/linux_t1-LP.dtb
echo ${RESULT_DIR}/${RESULT_FILE2_LP}
