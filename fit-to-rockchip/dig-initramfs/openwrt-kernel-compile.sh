...
PATH="${OPENWRT_STAGING_DIR}/toolchain-aarch64_generic_gcc-14.2.0_musl/bin:${OPENWRT_STAGING_DIR}/host/bin:${PATH}"
...
make -C ${OPENWRT_KERNEL_DIR} \
	...
	KBUILD_HOSTLDFLAGS="-L${OPENWRT_DIR}/staging_dir/host/lib" CONFIG_SHELL="bash" \
